...
class Profile extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('hhttps://job-search-application-api.vercel.app/user/'+ user.id)
             .then(response => {
    ...
    delEducation(ed) {
        ...
        axios
            .put('https://job-search-application-api.vercel.app/user/edit_profile/' + user.id, this.state.userdetails)
            .then(response => {
